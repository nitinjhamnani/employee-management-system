...
public class EmployeeDashboardController {
    ...
    @Autowired
    private com.employee.service.CustomerService customerService;
    ...
    public String showCustomerForm(Model model) {
        Employee employee = getCurrentEmployee();
        model.addAttribute("employee", employee);
        model.addAttribute("customer", new com.employee.model.Customer());
        return "employee/customer-form";
    }
    
    @PostMapping("/customers/save")
    public String saveCustomer(@ModelAttribute com.employee.model.Customer customer,
                              RedirectAttributes redirectAttributes) {
        try {
